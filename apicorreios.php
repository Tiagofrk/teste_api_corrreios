...
include('status.php');
	...
	if(isset($_GET) || isset($_POST)){
		...
		$obj = isset($request['cod']) ? $request['cod'] : false;

		if($obj){

			$post = array('Objetos' => $obj);
			$ch = curl_init();
			curl_setopt($ch, CURLOPT_URL, "https://www2.correios.com.br/sistemas/rastreamento/default.cfm");
...
/*Resposta em json da api do correios */ 
